    ...
    <div class="page" asscroll-container>
      ...
      <div class="page-wrapper" asscroll> 
        <section class="hero">
          <div class="hero-wrapper">
            ...
            <div class="hero-main">
              ...
              <p class="hero-main-description">Cybersecurity Student</p>
            </div>

            <div class="hero-second">
              <p class="hero-second-subheading first-sub">Ryan Tan</p>
        ...
        <div class="section-detail-wrapper">
          <h3 class="section-heading"> Childhood </h3>
          <p class="section-text"> I was born in Cupertino, California where I spent most of my childhood. My parents raised my sister and I with the help of my grandmother from my mom's side, who lives with us. I had a relatively uneventful childhood, where I developed an intrest in computer science, programming, and the digital world.</p>
        </div>
      </section>
      ...
      <section class="second-section section right">
        <div class="progress-wrapper progress-bar-wrapper-right">
          <div class="progress-bar blue-background">
            
          </div>
        </div>
        <div class="section-intro-wrapper blue-text">
          <h1 class="section-title">
            ...
            <div class="section-title-decoration styleThree blue-background"></div>
          </h1>
        <span class="section-number">02</span>
      </div>

        <div class="section-detail-wrapper blue-text">
          <h3 class="section-heading"> WildEyeAi </h3>
          <p class="section-text">Using Ai, a group of my freinds and I created a tool to detect animals in images and videos. It's meant to run on low end hardware, like a passive camera to take help identify endagered species. </p>
          <h3 class="section-heading"> A couple of Certificates </h3>
      ...
      <section class="third-section section left">
        <div class="progress-wrapper progress-bar-wrapper-left">
          <div class="progress-bar green-background">

          </div>
        </div>
        <div class="section-intro-wrapper">
          <h1 class="section-title green-text">
            ...
            <div class="section-title-decoration styleThree green-background"></div>
          </h1>
        <span class="section-number">03</span>
      </div>

        <div class="section-detail-wrapper green-text">
          <h3 class="section-heading"> Email </h3>
          <p class="section-text">4niemfan@gmail.com</p>
          <h3 class="section-heading"> Discord </h3>
          <p class="section-text">Lord Potato</p>
        </div>
